...
public:
	...
	/* Bo: get TransFunc1DKeys of the transfer function */
	TransFunc1DKeys * getTransFunc1D() { return dynamic_cast<TransFunc1DKeys*>(value_);}
	TransFunc2DPrimitives * getTransFunc2D() { return dynamic_cast<TransFunc2DPrimitives*>(value_);}
